...
var file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_goTypes = []any{
...
func file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_msgTypes[0].Exporter = func(v any, i int) any {
