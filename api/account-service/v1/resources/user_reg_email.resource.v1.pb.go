...
// 	protoc        v3.21.6
// source: api/account-service/v1/resources/user_reg_email.resource.v1.proto
...
func (x *UserRegEmail) Reset() {
	*x = UserRegEmail{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_msgTypes[0]
...
func (*UserRegEmail) Descriptor() ([]byte, []int) {
	return file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescGZIP(), []int{0}
}
...
var file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x67, 0x5f, 0x65, 0x6d, 0x61, 0x69,
	0x6c, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x70, 0x72,
	...
	0x22, 0xbf, 0x01, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x45, 0x6d, 0x61, 0x69,
	...
	0x69, 0x6c, 0x42, 0x8f, 0x01, 0x0a, 0x1b, 0x73, 0x61, 0x61, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e,
...
var (
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescOnce sync.Once
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescData = file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDesc
)

func file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescGZIP() []byte {
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescOnce.Do(func() {
		file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescData)
	})
	return file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDescData
}

var file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_goTypes = []interface{}{
	(*UserRegEmail)(nil), // 0: saas.api.account.resourcev1.UserRegEmail
}
var file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_depIdxs = []int32{
...
func init() { file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_init() }
func file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_init() {
	if File_api_account_service_v1_resources_user_reg_email_resource_v1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_goTypes,
		DependencyIndexes: file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_depIdxs,
		MessageInfos:      file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_msgTypes,
	}.Build()
	File_api_account_service_v1_resources_user_reg_email_resource_v1_proto = out.File
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_rawDesc = nil
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_goTypes = nil
	file_api_account_service_v1_resources_user_reg_email_resource_v1_proto_depIdxs = nil
}
