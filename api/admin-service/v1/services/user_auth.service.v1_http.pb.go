...
const OperationSrvUserAuthV1LoginByEmail = "/saas.api.admin.servicev1.SrvUserAuthV1/LoginByEmail"
const OperationSrvUserAuthV1LoginByOpenApi = "/saas.api.admin.servicev1.SrvUserAuthV1/LoginByOpenApi"
const OperationSrvUserAuthV1LoginByPhone = "/saas.api.admin.servicev1.SrvUserAuthV1/LoginByPhone"
const OperationSrvUserAuthV1LoginOrSignupByEmail = "/saas.api.admin.servicev1.SrvUserAuthV1/LoginOrSignupByEmail"
const OperationSrvUserAuthV1LoginOrSignupByPhone = "/saas.api.admin.servicev1.SrvUserAuthV1/LoginOrSignupByPhone"
const OperationSrvUserAuthV1Ping = "/saas.api.admin.servicev1.SrvUserAuthV1/Ping"
const OperationSrvUserAuthV1RefreshToken = "/saas.api.admin.servicev1.SrvUserAuthV1/RefreshToken"
const OperationSrvUserAuthV1SendEmailChangeCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendEmailChangeCode"
const OperationSrvUserAuthV1SendEmailChangePasswdCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendEmailChangePasswdCode"
const OperationSrvUserAuthV1SendEmailForgotPasswdCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendEmailForgotPasswdCode"
const OperationSrvUserAuthV1SendEmailLoginCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendEmailLoginCode"
const OperationSrvUserAuthV1SendEmailSignupCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendEmailSignupCode"
const OperationSrvUserAuthV1SendPhoneChangeCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendPhoneChangeCode"
const OperationSrvUserAuthV1SendPhoneChangePasswdCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendPhoneChangePasswdCode"
const OperationSrvUserAuthV1SendPhoneForgotPasswdCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendPhoneForgotPasswdCode"
const OperationSrvUserAuthV1SendPhoneLoginCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendPhoneLoginCode"
const OperationSrvUserAuthV1SendPhoneSignupCode = "/saas.api.admin.servicev1.SrvUserAuthV1/SendPhoneSignupCode"
const OperationSrvUserAuthV1SignupByEmail = "/saas.api.admin.servicev1.SrvUserAuthV1/SignupByEmail"
const OperationSrvUserAuthV1SignupByPhone = "/saas.api.admin.servicev1.SrvUserAuthV1/SignupByPhone"
...
func RegisterSrvUserAuthV1HTTPServer(s *http.Server, srv SrvUserAuthV1HTTPServer) {
	r := s.Route("/")
	r.GET("/api/v1/admin/auth/ping", _SrvUserAuthV1_Ping0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-phone-signup-code", _SrvUserAuthV1_SendPhoneSignupCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-email-signup-code", _SrvUserAuthV1_SendEmailSignupCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/signup-by-email", _SrvUserAuthV1_SignupByEmail0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/signup-by-phone", _SrvUserAuthV1_SignupByPhone0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/login-or-signup-by-phone", _SrvUserAuthV1_LoginOrSignupByPhone0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/login-or-signup-by-email", _SrvUserAuthV1_LoginOrSignupByEmail0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/refresh-token", _SrvUserAuthV1_RefreshToken0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/login-by-email", _SrvUserAuthV1_LoginByEmail0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/login-by-phone", _SrvUserAuthV1_LoginByPhone0_HTTP_Handler(srv))
	r.POST("/api/v1/open-api/auth/login", _SrvUserAuthV1_LoginByOpenApi0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-email-login-code", _SrvUserAuthV1_SendEmailLoginCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-phone-login-code", _SrvUserAuthV1_SendPhoneLoginCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-email-forgot-passwd-code", _SrvUserAuthV1_SendEmailForgotPasswdCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-phone-forgot-passwd-code", _SrvUserAuthV1_SendPhoneForgotPasswdCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-email-change-passwd-code", _SrvUserAuthV1_SendEmailChangePasswdCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-phone-change-passwd-code", _SrvUserAuthV1_SendPhoneChangePasswdCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-email-change-code", _SrvUserAuthV1_SendEmailChangeCode0_HTTP_Handler(srv))
	r.POST("/api/v1/admin/auth/send-phone-change-code", _SrvUserAuthV1_SendPhoneChangeCode0_HTTP_Handler(srv))
}
...
func (c *SrvUserAuthV1HTTPClientImpl) LoginByEmail(ctx context.Context, in *resources.LoginByEmailReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	...
	pattern := "/api/v1/admin/auth/login-by-email"
...
func (c *SrvUserAuthV1HTTPClientImpl) LoginByPhone(ctx context.Context, in *resources.LoginByPhoneReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/login-by-phone"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) LoginOrSignupByEmail(ctx context.Context, in *resources.LoginOrSignupByEmailReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/login-or-signup-by-email"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) LoginOrSignupByPhone(ctx context.Context, in *resources.LoginOrSignupByPhoneReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/login-or-signup-by-phone"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) Ping(ctx context.Context, in *resources.PingReq, opts ...http.CallOption) (*resources.PingResp, error) {
	...
	pattern := "/api/v1/admin/auth/ping"
...
func (c *SrvUserAuthV1HTTPClientImpl) RefreshToken(ctx context.Context, in *resources.RefreshTokenReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/refresh-token"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendEmailChangeCode(ctx context.Context, in *resources.SendEmailVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	...
	pattern := "/api/v1/admin/auth/send-email-change-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendEmailChangePasswdCode(ctx context.Context, in *resources.SendEmailVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-email-change-passwd-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendEmailForgotPasswdCode(ctx context.Context, in *resources.SendEmailVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-email-forgot-passwd-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendEmailLoginCode(ctx context.Context, in *resources.SendEmailVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-email-login-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendEmailSignupCode(ctx context.Context, in *resources.SendEmailVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-email-signup-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendPhoneChangeCode(ctx context.Context, in *resources.SendPhoneVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-phone-change-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendPhoneChangePasswdCode(ctx context.Context, in *resources.SendPhoneVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-phone-change-passwd-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendPhoneForgotPasswdCode(ctx context.Context, in *resources.SendPhoneVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-phone-forgot-passwd-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendPhoneLoginCode(ctx context.Context, in *resources.SendPhoneVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-phone-login-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SendPhoneSignupCode(ctx context.Context, in *resources.SendPhoneVerifyCodeReq, opts ...http.CallOption) (*resources.SendVerifyCodeResp, error) {
	var out resources.SendVerifyCodeResp
	pattern := "/api/v1/admin/auth/send-phone-signup-code"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SignupByEmail(ctx context.Context, in *resources.SignupByEmailReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/signup-by-email"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *SrvUserAuthV1HTTPClientImpl) SignupByPhone(ctx context.Context, in *resources.SignupByPhoneReq, opts ...http.CallOption) (*resources.LoginResp, error) {
	var out resources.LoginResp
	pattern := "/api/v1/admin/auth/signup-by-phone"
	path := binding.EncodeURL(pattern, in, false)
