...
var file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_goTypes = []any{
...
func file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_msgTypes[0].Exporter = func(v any, i int) any {
