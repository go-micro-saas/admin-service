...
// 	protoc        v3.21.6
// source: api/admin-service/v1/resources/user_reg_phone.resource.v1.proto
...
func (x *UserRegPhone) Reset() {
	*x = UserRegPhone{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_msgTypes[0]
...
func (*UserRegPhone) Descriptor() ([]byte, []int) {
	return file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescGZIP(), []int{0}
}
...
var File_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto protoreflect.FileDescriptor

var file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDesc = []byte{
	...
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x72, 0x65, 0x67, 0x5f, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x2e,
	...
	0x0c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x67, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x1d, 0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x09, 0x75, 0x73, 0x65, 0x72, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x42, 0x87,
...
var (
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescOnce sync.Once
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescData = file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDesc
)

func file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescGZIP() []byte {
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescOnce.Do(func() {
		file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescData = protoimpl.X.CompressGZIP(file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescData)
	})
	return file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDescData
}

var file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_goTypes = []interface{}{
	(*UserRegPhone)(nil), // 0: saas.api.admin.resourcev1.UserRegPhone
}
var file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_depIdxs = []int32{
...
func init() { file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_init() }
func file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_init() {
	if File_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_goTypes,
		DependencyIndexes: file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_depIdxs,
		MessageInfos:      file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_msgTypes,
	}.Build()
	File_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto = out.File
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_rawDesc = nil
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_goTypes = nil
	file_api_admin_service_v1_resources_user_reg_phone_resource_v1_proto_depIdxs = nil
}
