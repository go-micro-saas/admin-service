...
// AdminEventHistorySchema AdminEventHistory
var AdminEventHistorySchema AdminEventHistory

// NewAdminEventHistory new schema
func NewAdminEventHistory() *AdminEventHistory {
	return &AdminEventHistory{}
}

const (
	TableName = "bas_admin_event_history"
...
// AdminEventHistory ENGINE InnoDB CHARSET utf8mb4 COMMENT '事件历史'
type AdminEventHistory struct {
...
func (s *AdminEventHistory) TableName() string {
	return TableName
}

// CreateTableMigrator create table migrator
func (s *AdminEventHistory) CreateTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationInterface {
	return migrationuitl.NewCreateTable(migrator, migrationuitl.Version, s)
}

// DropTableMigrator create table migrator
func (s *AdminEventHistory) DropTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationInterface {
	return migrationuitl.NewDropTable(migrator, migrationuitl.Version, s)
}

// TableSQL table SQL
func (s *AdminEventHistory) TableSQL() string {
	return `
create table bas_admin_event_history (
