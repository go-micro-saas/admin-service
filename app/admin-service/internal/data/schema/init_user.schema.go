...
const (
	...
	DefaultInitUserNickname        = "admin"
	DefaultInitUserPhone           = "13800138000"
	DefaultInitUserEmail           = "admin@admin.user"
	DefaultInitUserPassword        = "Admin.123456"
)
...
func (s *user) InitializeUser(dbConn *gorm.DB) migrationutil.MigrationInterface {
	var (
		...
		migrationIdentifier = migrationVersion + ":" + tableName + ":initialize.admin:" + userEmail
	)
