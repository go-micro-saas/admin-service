...
// NewUserDataRepo new data repo
func NewUserDataRepo(logger log.Logger, dbConn *gorm.DB) datarepos.UserDataRepo {
	logHelper := log.NewHelper(log.With(logger, "module", "admin-service/data/user"))
	return &userDataRepo{
		log:    logHelper,
		dbConn: dbConn,
	}
